...
class DepthCameraService<T>(
    ...
    private val TAG: String = DepthCameraService::class.java.simpleName

    private val cameraManager = context.getSystemService(CameraManager::class.java)
    private val imageReader = ImageReader.newInstance(640, 640, ImageFormat.DEPTH16, 2)
    ...
    override fun onImageAvailable(reader: ImageReader?) {
        ...
        if (image != null && image.format == ImageFormat.DEPTH16) {
            ...
            context.onNewImage(depthRanges)
        }
